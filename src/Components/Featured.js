                        ...
                        >
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 xl:w-full flex flex-col text-center items-center">
                                        ...
                                        <video className="rounded-t-2xl w-full" controls poster={require('./assets/Rectangle 1450.png')}>
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 w-full flex flex-col text-center items-center">
                                        <img className="w-full" src={require('./assets/Rectangle 1450.png')}></img>
                                        <audio className="absolute top-64 h-15 w-full" controls="transparent">
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 w-full flex flex-col text-center items-center">
                                        <img className="w-full" src={require('./assets/Rectangle 1450.png')}></img>
                                        <audio className="absolute top-64 h-15 w-full" controls>
                ...
                <div className="w-full flex justify-center xl:mt-16">
                    <div className="flex justify-start">
                        <button className="swiper-button-prev text-gray-400 focus:outline-none sm:px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="ms-4" width="57" height="40" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                    ...
                    <div className="flex justify-end">
                        <button className="swiper-button-next text-gray-400 focus:outline-none sm:px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="me-3" width="57" height="40" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
