                        ...
                        >
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 xl:w-full flex flex-col text-center items-center">
                                        ...
                                        <video className="rounded-t-2xl 2xl:h-76 xl:h-76 lg:h-64 sm:h-99.5 h-95 bg-black w-full" controls poster={require('./assets/Rectangle 275.png')}>
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 w-full flex flex-col text-center items-center">
                                        ...
                                        <audio onClick={toggleaudio} className="absolute 2xl:top-64 xl:top-64 lg:top-48 bottom-40 xl:h-15 lg:h-14 w-full" controls="transparent">
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 w-full flex flex-col text-center items-center">
                                        <img className="w-full xl:h-76 lg:h-64 sm:h-99.5 h-95 rounded-t-2xl" src={require('./assets/Rectangle 218.png')}></img>
                                        <audio className="absolute 2xl:top-64 xl:top-64 lg:top-48 bottom-40 xl:h-15 lg:h-14 w-full" controls>
                            ...
                            <SwiperSlide>
                                <div class="flex flex-wrap md:-m-4 -mx-4 -mb-10 md:space-y-0 space-y-6">
                                    <div class="p-4 xl:w-full flex flex-col text-center items-center">
                                        {/* <img src={require('./assets/Rectangle 1450.png')}></img> */}
                                        <video className="rounded-t-2xl 2xl:h-76 xl:h-76 lg:h-64 sm:h-99.5 h-95 bg-black w-full" controls poster={require('./assets/Rectangle 1450.png')}>
