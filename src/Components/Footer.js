  ...
  return (
    <footer className="w-full flex flex-wrap md:flex-row flex-col justify-around items-center bg-cover h-full bg-blue-1000 p-20">
      ...
      <div className="md:text-left md:-mt-10 mt-10">
        ...
        <br />
        <div className="md:justify-start justify-center flex gap-6">
          ...
          <a href="https://www.facebook.com/figmadesign/" class="text-white">
          ...
          <a href="https://www.linkedin.com/company/figma?original_referer=https%3A%2F%2Fwww.google.com%2F" className="text-white">
            <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
