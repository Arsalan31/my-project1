...
function Footer() {
  return (
    <footer className="h-1/2 w-full flex flex-wrap md:flex-row flex-col justify-around items-center p-40">
      <div className="p-5 text-center">
        <h2 className="title-font font-medium text-white tracking-widest text-xl pb-6">Pages</h2>
        <nav className="list-none mb-10">
          <li className="pb-4">
            <a href="#Home" className="text-white font-normal text-base pb-2 ">Home</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2">Product</a>
          </li>
          <li className="pb-4">
            <a href="#Pricing" className="text-white font-normal text-base pb-2">Pricing</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2">About</a>
          </li>
          <li className="pb-4">
            <a href="#Contact" className="text-white font-normal text-base pb-2">Contact</a>
          </li>
        </nav>
      </div>
      <div className="p-5 text-center">
        ...
        <nav className="list-none mb-10">
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Eleanor Edwards</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Ted Robertson</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Annette Russell</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Jennie Mckinney</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Gloria Richards</a>
          </li>
        </nav>
      </div>
      <div className="p-5 text-center">
        ...
        <nav className="list-none mb-10">
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Philip Jones</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Product</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Colleen Russell</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Marvin Hawkins</a>
          </li>
          <li className="pb-4">
            <a href="#" className="text-white font-normal text-base pb-2 cursor-pointer">Bruce Simmmons</a>
          </li>
        </nav>
      ...
      <div className="p-8 -mt-24">
        ...
        <p className="  text-white font-normal text-base  pb-3"><svg width="32" className="inline-flex " height="39" viewBox="0 0 32 39" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <br />
        <p className=" text-white text-base font-normal  pb-3"><svg width="21" className="inline-flex" height="33" viewBox="0 0 21 33" fill="none" xmlns="http://www.w3.org/2000/svg">
