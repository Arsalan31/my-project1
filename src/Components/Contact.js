    ...
    <section className="contact text-gray-600 body-font overflow-hidden">
      <div className="container px-auto py-28 mx-auto">
        ...
        <div class="flex flex-wrap-reverse lg:flex-wrap justify-center">
          ...
          <div class="flex flex-wrap xl:w-1/2 lg:w-1/2 w-full md:mt-10 mt-20">
            <div className="container flex flex-wrap ">
              <div class="md:w-1/3 w-full flex md:flex-col flex-row text-center items-center">
                ...
                <div class="md:flex-grow md:mt-6 ml-5">
            ...
            <div className="justify-items-center">
              <div className="md:justify-items-start justify-items-center flex gap-6 md:ml-5">
