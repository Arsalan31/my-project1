    ...
    <section className="contact text-gray-600 body-font overflow-hidden">
      <div className="container px-auto py-28 mx-auto">
        ...
        <div class="flex justify-center">
          <div className="contact-us p-3 m-10 xl:w-1/3 lg:w-1/5 w-full">
          ...
          <div class="flex flex-wrap xl:w-1/3 lg:w-1/5 w-full">
            <div class="md:w-1/3 w-full flex sm:flex-col flex-row text-center items-center">
