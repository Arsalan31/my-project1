...
function Contact() {
  return (
    <section className="contact text-gray-600 body-font mt-56">
      <div className="container px-5 pb-6 mx-auto">
        ...
        <div class="flex justify-center">
          ...
          <div class="flex flex-wrap ml-10 mt-5 md:space-y-0 space-y-6">
            <div class="p-4 md:w-1/3 w-full flex sm:flex-col flex-row text-center items-center">
            ...
            <div class="container px-5 py-24 mx-auto flex flex-wrap">
              <div class="map lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
