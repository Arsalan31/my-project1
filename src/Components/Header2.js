            ...
            <div className="flex flex-wrap justify-between content-center items-center bg-white ">
                ...
                <div className="list3 text-center flex md:bg-transparent lg:order-1 order-2 md:p-0 p-5 md:w-52 w-full bg-white">
                    ...
                    {(toggleMenu || screenWidth > 1024) && (
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={togglelang} className="lg:text-gray-5 text-white ms-5 text-sm font-bold uppercase flex px-5 py-2 focus:outline-none">
                    ...
                    {(togglelanguage) && (
                        <nav id="dropdown" className="lg:list-none list5 p-5 lg:flex flex-col bg-gray-5 hidden" aria-labelledby="dropdownDefaultButton">
                            <li className="pb-4">
