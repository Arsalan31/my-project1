...
function Header2() {
    ...
    return (
        <header className="w-full z-50 fixed">
            <div className="flex w-full lg:flex-wrap h-28 flex-wrap-reverse justify-between content-center items-center absolute bg-white">
                ...
                {(toggleMenu || screenWidth > 1024) && (
                    <div className="list7 list-none lg:bg-white bg-green-20 gap-3 lg:px-0 flex lg:flex-row flex-col order-0 lg:justify-center justify-start">
                        ...
                        <li>
                            <div className="flex hover:bg-gray-8">
                                <a onMouseEnter={toggleAbt} ref={ref} className="lg:w-auto w-1/2 h-full cursor-pointer uppercase lg:block hidden py-3 lg:py-10 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Who We Are</a>
                        ...
                        <li>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt1} ref={ref1} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 lg:px-1 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">What We Do</a>
                        ...
                        <li>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt2} ref={ref2} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 lg:px-1 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">How We Work</a>
                        ...
                        <li>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt3} ref={ref3} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 lg:px-1 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Where We Work</a>
                        ...
                        <li>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt4} ref={ref4} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 lg:px-1 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">RESOURCES & MEDIA</a>
                        ...
                        <li>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt5} ref={ref5} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 lg:px-1 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Get Involved</a>
                ...
                <div className="list-none relative text-center lg:flex hidden md:bg-transparent lg:order-1 order-2 md:p-0 p-5 md:w-52 w-full bg-white">
                    ...
                    <li>
                        <a>
                            <button onMouseEnter={toggleLang} ref={lang} className="lg:text-gray-5 lg:py-10 hover:bg-gray-8 text-white ms-5 text-sm font-bold uppercase flex px-5 py-2 focus:outline-none">
