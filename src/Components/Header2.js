        ...
        <header className="w-full z-50 fixed">
            <div className="flex w-full lg:flex-wrap h-18 flex-wrap-reverse justify-between content-center items-center absolute bg-white">
                ...
                {(toggleMenu || screenWidth > 1024) && (
                    <div className="list7 list-none lg:bg-white bg-green-20 gap-4 lg:px-0 px-2 flex lg:flex-row flex-col order-0 lg:justify-center justify-start">
                ...
                <div className="list-none relative text-center lg:flex hidden md:bg-transparent lg:order-1 order-2 md:p-0 p-5 md:w-52 w-full bg-white">
                    ...
                    <li>
                        <a>
                            <button onMouseEnter={toggleLang} ref={lang} className="lg:text-gray-5 text-white ms-5 text-sm font-bold uppercase flex px-5 py-2 focus:outline-none">
