...
function Header2() {
    ...
    return (
        <header className="w-full z-50 fixed">
            <div className="flex w-full lg:flex-wrap lg:h-28 h-18 flex-wrap-reverse justify-between items-center absolute bg-white">
                ...
                {(toggleMenu || screenWidth > 1024) && (
                    <div className="list7 list-none lg:bg-white h-full gap-2 lg:px-0 flex lg:flex-row flex-col order-0 lg:justify-center justify-start">
                        <div className="flex lg:flex-row flex-col lg:bg-white bg-green-20 overflow-auto overflow-y-visible lg:px-0 px-8">
                            ...
                            <li ref={ref}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt} className="lg:w-auto w-1/2 h-full cursor-pointer uppercase lg:block hidden py-3 lg:py-10 hover:bg-gray-8 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Who We Are</a>
                            ...
                            <li ref={ref1}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt1} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 hover:bg-gray-8 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">What We Do</a>
                            ...
                            <li ref={ref2}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt2} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 px-2 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">How We Work</a>
                            ...
                            <li ref={ref3}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt3} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 px-2 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Where We Work</a>
                            ...
                            <li ref={ref4}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt4} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 px-2 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">RESOURCES & MEDIA</a>
                            ...
                            <li ref={ref5}>
                                <div className="flex">
                                    <a onMouseEnter={toggleAbt5} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-10 px-2 hover:bg-gray-8 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Get Involved</a>
                ...
                <div className="list-none relative text-center lg:flex hidden md:bg-transparent lg:order-1 order-2 md:p-0 p-5 md:w-52 w-full bg-white">
                    <button className="font-bold uppercase ms-3 py-2 hover:bg-gray-8 px-2 focus:outline-none">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.3604 9.16667C15.3604 12.2963 12.8234 14.8333 9.69377 14.8333C6.56415 14.8333 4.0271 12.2963 4.0271 9.16667C4.0271 6.03705 6.56415 3.5 9.69377 3.5C12.8234 3.5 15.3604 6.03705 15.3604 9.16667Z" stroke="#535052" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M18.0271 17.5L14.4021 13.875" stroke="#535052" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <li ref={lang}>
                        <a>
                            <button onMouseEnter={toggleLang} className="lg:text-gray-5 lg:py-10 hover:bg-gray-8 text-white ms-5 text-sm font-bold uppercase flex px-5 py-2 focus:outline-none">
