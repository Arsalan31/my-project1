    ...
    return (
        <header className="w-full z-50 fixed">
            <div className="flex w-full lg:flex-wrap flex-wrap-reverse justify-between content-center items-center absolute bg-white">
                <img href="Akdn" className="img lg:flex hidden" src={require('./assets/AKDN Identity with Tag Line 1.png')}></img>
                <img href="Akdn" className="img lg:hidden flex" src={require('./assets/Green.png')}></img>
                ...
                {(toggleMenu || screenWidth > 1024) && (
                    <div className="list7 list-none lg:bg-white bg-green-20 flex lg:flex-row flex-col py-6 order-0 lg:justify-center justify-start">
                        ...
                        <li ref={ref}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt} className="lg:w-auto w-1/2 cursor-pointer uppercase lg:block hidden py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Who We Are</a>
                        ...
                        <li ref={ref1}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt1} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">What We Do</a>
                        ...
                        <li ref={ref2}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt2} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">How We Work</a>
                        ...
                        <li ref={ref3}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt3} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Where We Work</a>
                        ...
                        <li ref={ref4}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt4} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">RESOURCES & MEDIA</a>
                        ...
                        <li ref={ref5}>
                            <div className="flex">
                                <a onMouseEnter={toggleAbt5} className="hidden lg:w-auto w-1/2 cursor-pointer uppercase lg:block py-3 lg:py-2 px-2 font-bold text-xs leading-7 lg:text-gray-5 text-white focus:outline-none">Get Involved</a>
                ...
                <div className="list-none relative text-center lg:flex hidden md:bg-transparent lg:order-1 order-2 md:p-0 p-5 md:w-52 w-full bg-white">
                    ...
                    <li ref={lang}>
                        <a>
                            <button onMouseEnter={toggleLang} className="lg:text-gray-5 text-white ms-5 text-sm font-bold uppercase flex px-5 py-2 focus:outline-none">
