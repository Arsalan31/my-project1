            ...
            <div className='background'>
                <nav className="container flex justify-between px-4 py-8 mx-auto bg-transparent">
                    <div className="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div className="navigation-menu hidden w-full md:block md:w-auto" id="navbar-default">
                        ...
                        <div className="navigation-menu hidden w-full md:block md:w-auto" id="navbar-default" >
                            <ul className="lg:w-2/5 inline-flex lg:justify-center ml-5 lg:ml-0">
                                ...
                                <a href="https://www.linkedin.com/company/figma?original_referer=https%3A%2F%2Fwww.google.com%2F" class="li ml-3 text-white cursor-pointer">
                                    <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 id="#Home" className="heading mt-12 sm:mt-28 text-6xl font-normal  text-center text-white">The best products
                    <br className="hidden sm:block" /> start with Figma
                </h1>
                <h4 className='sub-heading text-center text-3xl mt-10 sm:mt-28 text-white'>Most calendars are designed for teams. <br className="sm:hidden" />Slate is designed
                    <br className="hidden sm:block" /> for freelancers
                </h4>
                <center>
                    <button className="button1 text-center  text-white mt-14 border-0 py-3 px-4 w-60 h-14 focus:outline-none hover:bg-blue-600">Show/Hide Features</button>
                    <br />
                    <button className="button1 text-center mt-3 text-white  border-0 py-3 px-4 w-60 h-14 focus:outline-none hover:bg-blue-600">Show/Hide Partners</button>
                    <br />
