    ...
    return (
        <header>
            <div className='background'>
                    ...
                    <div className="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div className="hidden w-full md:block md:w-auto" id="navbar-default" >
                            <div className="lg:w-2/5 inline-flex lg:justify-center ml-5 lg:ml-0">
                                <a href="https://twitter.com/figma?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="text-white cursor-pointer">
                                ...
                                <a href="https://www.facebook.com/figmadesign/" class="ml-3 text-white cursor-pointer">
                ...
                <h1 id="#Home" className="heading mt-36 sm:text-5xl font-normal  text-center text-white">The best products
                    <br className="hidden sm:block" /> start with Figma
                </h1>
                <h4 className='sub-heading text-center sm:text-3xl mt-20 text-white'>Most calendars are designed for teams. <br className="sm:hidden" />Slate is designed
