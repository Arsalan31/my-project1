                ...
                <div className="container nav md:my-0 my-10 px-10 flex flex-wrap justify-between content-center items-center xl:mx-64 lg:mx-32 mx-auto bg-transparent ">
                    ...
                    {(toggleMenu || screenWidth > 767) && (
                        <div className="list2 flex flex-col md:p-4 md:mt-10 mt-10 md:bg-transparent bg-white text-indigo-650 md:border-transparent border-t-2 border-white md:flex-row md:text-sm md:font-medium  w-full md:block md:w-auto">
                            <li>
                                <a href="Udix" className="cursor-pointer uppercase block py-2 pe-4 ps-3 md:text-white text-indigo-650 font-normal text-1xl leading-7 rounded md:bg-transparent focus-within: dark:text-white" aria-current="page">Home</a>
                            </li>
                            <li>
                    ...
                    {(toggleMenu || screenWidth > 767) && (
                        <div className="list3 text-center flex md:bg-transparent md:p-0 p-5 md:w-52 w-full bg-white">
                            <button className="2xl:text-indigo-650 text-indigo-650 text-sm font-bold uppercase md:text-white ms-3 py-2">sign in</button>
                            <button className="2xl:text-indigo-650 text-indigo-650 md:text-white ms-5 2xl:border-indigo-650 border-indigo-650 text-sm font-bold uppercase md:border-white border-2 px-5 py-2">sign up</button>
                        </div>
                    )}
                </div>
            </nav>
