    ...
    return (
        <header className="w-full absolute">
            <nav className="flex justify-between md:opacity-90">
                <div className="container nav md:my-0 lg:px-0 px-10 py-5 flex flex-wrap justify-between content-center items-center xl:mx-36 lg:mx-20 mx-auto bg-transparent ">
