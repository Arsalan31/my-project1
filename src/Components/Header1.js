    ...
    return (
        <header className="w-full absolute">
            <nav className="flex justify-between md:opacity-90">
                <div className="container nav md:my-0 lg:px-0 px-10 py-5 flex flex-wrap justify-between content-center items-center xl:mx-40 lg:mx-28 mx-auto bg-transparent ">
                    <img src={require('./assets/udix..png')} className="bg-no-repeat flex-none order-0 flex-grow-0 block cursor-pointer" />
                    ...
                    {(toggleMenu || screenWidth > 767) && (
                        <div className="list2 flex flex-col md:p-4 2xl:-ms-96 xl:-ms-40 lg:-ms-40 md:bg-transparent bg-white text-indigo-650 md:border-transparent border-t-2 border-white md:flex-row md:text-sm md:font-medium  w-full md:block md:w-auto">
                            <li>
