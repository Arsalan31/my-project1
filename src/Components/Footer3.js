            ...
            <div className="lg:flex-row flex-col bg-blue-80 border-t border-b pt-8 pb-3 border-blue-80 flex justify-center">
                ...
                <div className="lg:w-1/3 w-full flex lg:flex-row flex-col justify-center">
                    ...
                    <div className="flex justify-center items-start gap-4 pt-5 lg:w-1/2">
                        <a href="#">
                            <svg className="In" width="18" height="18" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#">
                            <svg className="fb" width="10" height="18" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
