            ...
            <div className="container px-28 pb-6 mx-auto">
                <div className="flex flex-wrap-reverse lg:flex-wrap justify-center">
                    ...
                    <div className="flex flex-col flex-none flex-grow-0 order-0 md:order-1 text-center lg:w-1/2 mt-32 mb-20">
                        ...
                        <h1 className="w-full font-bold text-black mt-8 md:text-end text-center sm:text-4xl text-4xl sm:leading-10 mb-2">is a leading provider of digital<br /> marketing services</h1>
                        <p className="w-full mt-10 font-normal text-base md:text-end text-center text-hex mb-20">Using proprietary tools and we run thousands of simultaneous self-funded
