    ...
    return (
        <section className="flex flex-col items-start w-full h-full bg-gray-200 flex-none order-2 flex-grow-0">
            ...
            <img className="image self-center mt-24"></img>
                <h1 className="w-full font-bold text-black mt-8 text-center sm:text-4xl text-4xl sm:leading-10 mb-2">is a leading provider of digital<br/> marketing services</h1>
