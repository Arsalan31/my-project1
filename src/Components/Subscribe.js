        ...
        <section>
            <div className="container sm:p-20 mx-auto bg-white">
                ...
                <div className="lg:flex hidden justify-end">
                    <img src={require('./assets/Group 5.png')} className="lg:flex hidden justify-end relative bottom-24 lg:-end-20"></img>
                </div>
            </div>
        </section>
    )
