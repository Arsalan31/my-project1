            ...
            <div className="container sm:p-14 p-2 py-6 mx-auto bg-white">
                <div className="flex flex-wrap lg:flex-wrap justify-center">
                    ...
                    <div class="flex flex-wrap sm:justify-center justify-start mt-10 ">
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 sm:flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-auto sm:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-5 sm:block inline-flex">
                                <div className="aka sm:w-18 sm:h-18 w-18 h-18">
                                </div>
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 sm:flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-auto sm:mb-7">
                            <div class="sm:flex-grow sm:w-auto w-full flex-none sm:block inline-flex sm:px-6 sm:py-3">
                                ...
                                <p class="text-xs font-bold mt-3 sm:w-full">Aga Khan Agency For Habitat</p>
                            </div>

                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-4 sm:block inline-flex">
                                ...
                                <p class="text-xs sm:hidden flex font-bold mt-2 w-full">Aga Khan Agency For Microfinance</p>
                            </div>
                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-5 sm:block inline-flex">
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 mb-7">
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:py-6 sm:block inline-flex">
                                <div className="aked h-10 w-40 xl:ms-14 sm:ms-11"></div>
                                <p class="text-xs font-bold mt-3">Aga Khan Fund For Economic Development</p>
                            </div>
                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow px-6 py-3 sm:block inline-flex">
                                <div className="akhs sm:flex hidden sm:h-22 sm:w-42"></div>
                                <div className="akhs1 sm:hidden flex h-10 w-11"></div>
                                <p class="text-xs sm:hidden flex font-bold mt-3">Aga Khan Health Services</p>
                            </div>
                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow px-6 py-5 sm:block inline-flex">
                                <div className="aktc sm:flex hidden sm:h-18 sm:w-42"></div>
                                <div className="aktc1 sm:hidden flex h-7 w-11"></div>
                                <p class="text-xs sm:hidden flex font-bold mt-3">Aga Khan Trust for Culture</p>
                            </div>
                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-3 sm:block inline-flex">
                                <div className="aku sm:ms-8 h-16 w-20 sm:h-16 sm:w-20"></div>
                                <p class="text-xs font-bold uppercase sm:mt-0 mt-7">The Aga Khan University</p>
                            </div>
                        </div>
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex h-16 flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-3 sm:block inline-flex">
                                <div className="uca w-14 h-14 sm:w-14 sm:h-14 xl:ms-12 lg:ms-6 md:ms-10 sm:ms-14"></div>
