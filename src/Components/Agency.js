            ...
            <div className="container sm:p-12 px-5 py-6 mx-auto bg-white">
                <div className="flex flex-wrap lg:flex-wrap justify-center">
                    ...
                    <div class="flex flex-wrap sm:justify-center justify-start mt-10 ">
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:px-6 py-7 sm:justify-center sm:flex-col sm:items-center items-start inline-flex">
                                ...
                                <p className="text-xs sm:hidden sm:ms-0 ms-8 flex font-bold mt-4">Aga Khan Academies</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                        ...
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-5 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="sm:h-13 sm:w-20 w-16 h-12" src={require('./assets/Screen Shot 2021-02-27 at 8.14 3.png')}></img>
                                <p class="text-xs sm:ms-0 ms-8 font-bold sm:mt-1 mt-3">Aga Khan Education Services</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-3 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="sm:h-15 sm:w-20 w-18 h-16" src={require('./assets/Screen Shot 2021-02-27 at 8.15 1.png')}></img>
                                <p class="text-xs sm:ms-0 ms-6 sm:mt-1 mt-5 font-bold">Aga Khan Foundation</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center py-6 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="h-10 w-16 sm:w-20" src={require('./assets/Screen Shot 2021-02-27 at 8.14 .png')}></img>
                                <p class="text-xs sm:ms-0 ms-8 font-bold mt-3">Aga Khan Fund For Economic Development</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-5 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="sm:w-20 sm:h-15 h-12 w-16" src={require('./assets/aku.png')}></img>
                                <p class="text-xs sm:ms-0 ms-8 flex font-bold sm:mt-0 mt-4">Aga Khan Health Services</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-5 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="sm:w-20 sm:h-15 h-12 w-16" src={require('./assets/aktc.png')}></img>
                                <p class="text-xs sm:ms-0 ms-8 flex font-bold sm:mt-0 mt-3">Aga Khan Trust for Culture</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-3 sm:flex-col sm:items-center items-start inline-flex">
                                <img className="h-12 w-16 sm:h-16 sm:w-20" src={require('./assets/Screen Shot 2021-02-27 at 8.14 6.png')}></img>
                                <p class="text-xs font-bold uppercase sm:ms-0 ms-8 sm:mt-1 mt-5">The Aga Khan University</p>
                            </div>
                        </div>
                        <div class="sm:p-4 box-content lg:w-1/6 md:w-1/3 w-full sm:w-60 h-auto flex flex-col sm:text-center items-start sm:items-center sm:border sm:border-b border-gray-300 sm:mb-7">
                            <div class="flex-grow sm:justify-center sm:px-6 py-3 sm:flex-col sm:items-center items-start inline-flex">
