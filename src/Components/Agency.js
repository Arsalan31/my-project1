            ...
            <div className="container sm:p-14 p-2 py-6 mx-auto bg-white">
                <div className="flex flex-wrap lg:flex-wrap justify-center">
                    ...
                    <div class="flex flex-wrap sm:justify-center justify-start mt-10 ">
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full sm:w-60 sm:h-36 flex sm:flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-auto mb-7">
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full h-14 sm:w-60 sm:h-36 flex sm:flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-auto mb-7">
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full h-14 sm:w-60 sm:h-36 flex flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 mb-7">
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full h-14 sm:w-60 sm:h-36 flex flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-7">
                            <div class="flex-grow sm:py-6 sm:block inline-flex">
                                <div className="aked sm:h-10 sm:w-40 xl:ms-14 ms-11"></div>
                        ...
                        <div class="sm:p-4 lg:w-1/5 md:w-1/3 w-full h-14 sm:w-60 sm:h-36 flex flex-col text-center items-start sm:items-center sm:border border-b border-gray-300 md:mb-7">
                            <div class="flex-grow sm:px-6 sm:py-3 sm:block inline-flex">
                                <div className="aku sm:h-16 sm:w-52"></div>
