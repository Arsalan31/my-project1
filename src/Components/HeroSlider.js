                        ...
                        >
                            <SwiperSlide>
                                ...
                                <div className="lg:bg-white bg-blue-30 backdrop-blur-md">
                                    <h3 className="relative px-4 py-2 lg:text-white text-gray-5 lg:bottom-28 lg:font-medium lg:text-4xl text-sm font-bold">AWARDING SUSTAINABLE ARCHITECTURE</h3>
