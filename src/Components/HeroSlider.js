                        ...
                        >
                            <SwiperSlide>
                                ...
                                <div className="lg:bg-white bg-blue-30 backdrop-blur-md">
                                    ...
                                    <p className="lg:bottom-24 lg:w-2/3 w-full px-4 lg:text-white text-gray-5 text-sm font-normal relative">"Sustainable architecture" is now well known, especially as a reaction to the risks inherent in climate change, but the Aga Khan Award for Architecture has been giving out its prize to projects that are good for people and the planet for at least 40 years.</p>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                            ...
                            <div className="w-full relative z-50 2xl:bottom-32 xl:bottom-32 lg:bottom-36 flex 2xl:end-7 lg:end-6 lg:justify-end justify-start">
